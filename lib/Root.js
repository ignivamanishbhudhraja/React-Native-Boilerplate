...
var _StringEn = require("./utilities/StringEn");
var _StringEn2 = _interopRequireDefault(_StringEn);
var _Progress = require("./components/common/Progress");
...
var Root = (function(_Component) {
  ...
  function Root(props) {
    ...
    return _possibleConstructorReturn(
      this,
      (Root.__proto__ || Object.getPrototypeOf(Root)).call(this, props)
    );
  }
  _createClass(Root, [
    {
      ...
      value: function render() {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_reactNativeReduxToast.Toast, {
            messageStyle: styles.toastStyle,
...
var styles = _reactNative.StyleSheet.create({
  container: { flex: 1, backgroundColor: _constants2.default.Colors.White },
  toastStyle: _extends(
