...
var localhost = "localhost:3000",
  ...
  staging = "";
var running_url = process.env.NODE_ENV === "production" ? staging : manish,
...
var Connection = (function() {
  ...
  _createClass(Connection, null, [
    ...
    {
      key: "getMedia",
      value: function getMedia(_id) {
        return mediaBase_url + _id;
      }
    },
    {
      key: "getStaticPageWithUrl",
      value: function getStaticPageWithUrl(url) {
