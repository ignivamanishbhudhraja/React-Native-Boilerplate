...
var Strings = {
  common: {
    ...
    receiveOtp:
      "You will receive an OTP on your Phone Number for verification!",
    name: "Full name",
    save: "Save",
    submit: "Submit",
    proceed: "Proceed",
  ...
  subscription: {
    ...
    resultIntoEndOfSubscription:
      "This will result into the end of subscription services.",
    ...
    onAgreeAccountWillBecomeIndividual:
      "If you agree the account will become individual account.",
    ...
    removeTeamMemberAcoountPermanently:
      "This will remove all your team member account permanently"
  },
  profile: {
    fullName: "Full name",
    ...
    completeProfileToWorkAsServiceProvider:
      "Complete your profile to work as a service provider",
  ...
  password: {
    ...
    confirm: "Confirm Password",
    forgotInstructions:
      "Enter your contact number below to receive OTP to reset your password."
  },
  menu: {
    profile: "My Profile",
  ...
  about: { terms: "Terms of service", privacy: "Privacy Policy" },
  otp: {},
  dashboard: { request: "Request Service Here" },
  settings: {
    ...
    onAgreeAccountDeletedPermanently:
      "If you agree the account will be deleted permanently.",
    schedule: "Schedule",
    scheduleYourAutoOnlineWorkingHour:
      "Schedule your auto online working hours ",
  ...
  validations: {
    ...
    validName:
      "Name must be 3 characters long and name field should contains only alphabets.",
    ...
    validatePassword:
      "Password should be 6-16 characters long and must be alphanumeric.",
  ...
  request: {
    ...
    rateYourExperienceWithSpaceOwner:
  ...
  services: {
    ...
    reportingWillCancelOngoingService:
      "Reporting will cancel your current ongoing service",
    reasonDescriptionReport:
      "Reporting will cancel your current ongoing service"
  },
  notification: {
    newoffer: "New Offer",
