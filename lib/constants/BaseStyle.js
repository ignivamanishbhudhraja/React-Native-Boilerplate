...
var x = _Dimensions2.default.get("window").width;
var y = _Dimensions2.default.get("window").height;
var ratioX = x < 375 ? (x < 320 ? 0.75 : 0.875) : 1;
var ratioY = y < 568 ? (y < 480 ? 0.75 : 0.875) : 1;
var base_unit = 16;
var unit = base_unit * ratioX;
function em(value) {
  return unit * value;
}
var BaseStyle = {
