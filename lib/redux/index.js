...
var _bookings = require("./modules/bookings");
var _bookings2 = _interopRequireDefault(_bookings);
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : { default: obj };
}
var config = { key: "primary", storage: _reactNative.AsyncStorage };
function getRootReducer() {
  return (0, _reduxPersist.persistCombineReducers)(config, {
    toast: _reactNativeReduxToast.toastReducer,
    app: _app2.default,
    nav: _nav2.default,
    user: _user2.default,
