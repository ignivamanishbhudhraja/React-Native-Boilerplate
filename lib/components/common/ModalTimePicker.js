...
var _jsxFileName = "src/components/common/ModalTimePicker.js";
...
var ModalTimePicker = (function(_Component) {
  _inherits(ModalTimePicker, _Component);
  function ModalTimePicker(props) {
    _classCallCheck(this, ModalTimePicker);
    var _this = _possibleConstructorReturn(
      this,
      (
        ModalTimePicker.__proto__ || Object.getPrototypeOf(ModalTimePicker)
      ).call(this, props)
    );
    _this.state = {
      date: new Date(),
      date2: new Date(),
      openTimePicker: _this.props.openTimePicker
    };
    return _this;
  }
  _createClass(ModalTimePicker, [
    {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactNative.TouchableOpacity,
                {
                  ...
                  onPress: function onPress() {
                    return _this2.props.onHideModalTimePicker();
                  },
              ...
              _react2.default.createElement(
                _reactNative.TouchableOpacity,
                {
                  style: { flex: 1 },
                  onPress: function onPress() {
                    _this2.props.onHideModalTimePicker();
                    _this2.props.onTimeModalValueChange(_this2.state.date);
                  },
            ...
            _react2.default.createElement(
              ...
              _reactNative.Platform.OS === "ios"
                ...
                : _react2.default.createElement(TimePickerAndroid, {
                    date: this.state.date,
                    mode: "time",
                    timeZoneOffsetInMinutes:
                      this.state.timeZoneOffsetInHours * 60,
  ...
  return ModalTimePicker;
})(_react.Component);
exports.default = ModalTimePicker;
var styles = _reactNative.StyleSheet.create({
  ...
  modalContainer: {
    width: _constants2.default.BaseStyle.DEVICE_WIDTH,
    height: _constants2.default.BaseStyle.DEVICE_HEIGHT / 100 * 30,
    position: "absolute",
    bottom: 0
  },
  modalButtonsContainer: { flexDirection: "row", backgroundColor: "white" },
  cancelButton: {
    textAlign: "left",
    marginLeft: 15,
  ...
  picker: { backgroundColor: _constants2.default.Colors.White }
});
