...
var _jsxFileName = "src/components/common/ComingSoon.js";
...
ComingSoon.defaultProps = { info: "Coming Soon", backgroundColor: "#fff" };
var styles = _reactNative.StyleSheet.create({
  ...
  message: _extends({ textAlign: "center" }, _constants2.default.Fonts.title, {
