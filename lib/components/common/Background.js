...
var _jsxFileName = "src/components/common/Background.js";
...
var Background = (function(_Component) {
  ...
  function Background(props) {
    ...
    return _possibleConstructorReturn(
      this,
      (Background.__proto__ || Object.getPrototypeOf(Background)).call(
        this,
        props
      )
    );
  ...
  _createClass(Background, [
    {
      ...
      value: function render() {
        return _react2.default.createElement(
          _reactNative.Image,
          {
            source: _constants2.default.Images.background,
