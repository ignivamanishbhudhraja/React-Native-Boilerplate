...
var _jsxFileName = "src/components/common/Avatar.js";
...
var _rnPlaceholder2 = _interopRequireDefault(_rnPlaceholder);
  ...
  _createClass(Avatar, [
    {
      ...
      value: function renderAvatar() {
        ...
        if (this.props.user && this.props.user.photo !== "") {
          return _react2.default.createElement(_reactNative.Image, {
            source: {
              uri: _connection2.default.getMedia(this.props.user.photo)
            },
            style: [
        ...
        return _react2.default.createElement(
          _reactNative.View,
          {
            style: [defaultStyles.container, this.props.container],
            __source: { fileName: _jsxFileName, lineNumber: 60 }
          },
          _react2.default.createElement(_reactNative.Image, {
            source: this.props.isCompany
              ? _constants2.default.Images.plus
              : _constants2.default.Images.customer,
            style: [defaultStyles.avatarStyle, this.props.avatarStyle],
      ...
      value: function renderInitials() {
        ...
        return _react2.default.createElement(
          _reactNative.View,
          {
            style: [
              defaultStyles.avatarStyle,
              { backgroundColor: _constants2.default.Colors.LightGray },
              this.props.avatarStyle
            ],
...
var defaultStyles = {
  avatarStyle: {
    ...
    alignItems: "center",
    width: _constants2.default.BaseStyle.DEVICE_WIDTH / 100 * 14,
    height: _constants2.default.BaseStyle.DEVICE_WIDTH / 100 * 14
  },
  textStyle: _extends(
  ...
  container: {
    padding: _constants2.default.BaseStyle.DEVICE_HEIGHT / 100 * 1,
    backgroundColor: _constants2.default.Colors.PrimaryColor
  }
};
Avatar.defaultProps = {
  user: { full_name: null, photo: null },
  isCompany: false,
  avatarStyle: {},
  textStyle: {}
};
