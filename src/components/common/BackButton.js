...
const BackButton = props => {
  let { label, onPress, title, containerStyle, buttonStyle, textStyle, imageStyle } = props;
  return (
...
const styles = StyleSheet.create({
  ...
  button:{
    ...
    marginTop:Constants.BaseStyle.DEVICE_HEIGHT===812?Constants.BaseStyle.DEVICE_HEIGHT/100*4.2:Constants.BaseStyle.DEVICE_HEIGHT/100*2.5,
  },
  backImage:{
